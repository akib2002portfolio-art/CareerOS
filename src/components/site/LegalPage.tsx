  ...
  return (
    <section className="section-y-top relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-8">
        ...
        <Reveal delay={0.1}>
          <p className="mt-6 max-w-[56ch] text-base leading-relaxed text-muted-foreground sm:text-base">
            {intro}
          </p>
        </Reveal>
            ...
            {blocks.map((b, i) => (
              <Reveal key={b.h} delay={i * 0.04}>
                ...
                >
                  ...
                  <p className="mt-4 text-base leading-relaxed text-muted-foreground sm:text-base">
                    {b.p}
                  </p>
                </div>
              </Reveal>
                  ...
                  return (
                    <li key={b.h}>
                      <a
                        ...
                        className={`-ml-px block border-l py-2 pl-5 text-base transition-colors duration-300 ${
                          isActive
