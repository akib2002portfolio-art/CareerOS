...
export function EvidenceSection() {
  ...
  const smoothProgress = useSpring(scrollYProgress, { stiffness: 240, damping: 36, mass: 0.5 });
  const draw = useTransform(smoothProgress, [0, 1], [0, 1]);
          ...
          <svg viewBox="0 0 560 370" className="w-full" fill="none" aria-hidden="true">
            ...
            {evidence.map((e, i) => (
              <motion.g
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.15 * i, duration: 0.6, ease: EASE_SMOOTH }}
